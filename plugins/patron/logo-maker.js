...
/* ---------- DRAGON BALL ---------- */
{
    ...
    async execute(m, { ednut, q, reply, from }) {
        if (!q) return reply('❌ Please provide text. Example: .dragonball Zed');
        try {
            await generateLogo(
                ednut,
                from,
...
/* ---------- DEADPOOL ---------- */
{
    ...
    async execute(m, { ednut, q, reply, from }) {
        if (!q) return reply('❌ Please provide text. Example: .deadpool Zed');
        try {
            await generateLogo(
                ednut,
                from,
...
/* ---------- NARUTO ---------- */
{
    ...
    async execute(m, { ednut, q, reply, from }) {
        if (!q) return reply('❌ Please provide text. Example: .naruto Zed');
        try {
            await generateLogo(
                ednut,
                from,
...
/* ---------- FUTURISTIC ---------- */
{
    ...
    async execute(m, { ednut, q, reply, from }) {
        if (!q) return reply('❌ Please provide text. Example: .futuristic Zed');
        try {
            await generateLogo(
                ednut,
                from,
...
/* ---------- CLOUDS ---------- */
{
    ...
    async execute(m, { ednut, q, reply, from }) {
        if (!q) return reply('❌ Please provide text. Example: .clouds Zed');
        try {
            await generateLogo(
                ednut,
                from,
...
/* ---------- ZODIAC ---------- */
{
    ...
    async execute(m, { ednut, q, reply, from }) {
        if (!q) return reply('❌ Please provide text. Example: .zodiac Zed');
        try {
            await generateLogo(
                ednut,
                from,
...
/* ---------- SAND ---------- */
{
    ...
    async execute(m, { ednut, q, reply, from }) {
        if (!q) return reply('❌ Please provide text. Example: .sand Zed');
        try {
            await generateLogo(
                ednut,
                from,
...
/* ---------- BIRTHDAY ---------- */
{
    ...
    async execute(m, { ednut, q, reply, from }) {
        if (!q) return reply('❌ Please provide a name. Example: .birthday Zed');
        try {
            await generateLogo(
                ednut,
                from,
